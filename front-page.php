                        ...
                        <div class="seq-screen">
                            <ul class="seq-canvas">
                                <li>
                                    ...
                                    <div class="seq-title">
                                        <h2 data-seq>¿Buscas un bachillerato diferente?<br>
                                            <hr>
                                        </h2>
                                ...
                                <li class="seq-in">
                                    ...
                                    <div class="seq-title text-center">
                                        <h2 data-seq>¿Y si terminas tu bachillerato? <br>
                                            <hr>
                                        </h2>
                                ...
                                <li>
                                    ...
                                    <div class="seq-title">
                                        <h2 data-seq>¿Quieres una formación integral?<br>
                                            <hr>
                                        </h2>
                                ...
                                <li>
                                    ...
                                    <div class="seq-title">
                                        <h2 data-seq>¡Descubre tu talento!<br>
                                            <hr>
                                        </h2>
                                ...
                                <li>
                                    ...
                                    <div class="seq-title">
                                        <h2 data-seq>¿Buscas una beca para seguir estudiando?<br>
                                            <hr>
                                        </h2>
                                ...
                                <li>
                                    ...
                                    <div class="seq-title">
                                        <h2 data-seq>¡Vive la emoción del deporte!<br>
                                            <hr>
                                        </h2>
                                ...
                                <li>
                                    ...
                                    <div class="seq-title text-center">
                                        <h2 data-seq>Haz la diferencia<br>
                                            <hr>
                                        </h2>
